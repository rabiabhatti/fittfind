...
import {Wrapper, ImpossibleBanner, Hero, BasketInput} from "../../components";
                ...
                <div className='column-start'>
                    {status_res ?
                        ...
                        <div className='column-start section-order-status-form'>
                            ...
                            <BasketInput className='section-order-status-form-input' title='Order number' name='order_no' width={100} onChange={this._onChange} value={order_no} />
