...
class IndexPage extends React.Component {
    ...
    componentDidMount() {
        ...
        scriptEl.src = 'https://app.ecwid.com/script.js?27677024&data_platform=code&data_date=2020-04-09'
        scriptEl.onload = () => {
            window.xProductBrowser("categoriesPerRow=3","views=grid(20,3) list(60) table(60)","categoryView=grid","searchView=list","id=my-store-27677024")
        };
    ...
    render() {
        ...
        // }
        const contents = `<div id="my-store-27677024"></div>`;

        return (
            <div>Test<div dangerouslySetInnerHTML={{__html: contents}} /></div>
